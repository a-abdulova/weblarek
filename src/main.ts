...
if (firstId)
  console.log("Товар из каталога по id: ", productsModel.getById(firstId));

console.log("Выбранный товар (до setSelected): ", productsModel.getSelected());
productsModel.setSelected(apiProducts.items[0] ?? null);
console.log(
  "Выбранный товар (после setSelected): ",
  productsModel.getSelected(),
);
...
console.log(
  "Покупатель, ошибки после payment+address: ",
  buyerModel.validate(),
);
